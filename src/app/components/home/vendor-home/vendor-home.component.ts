...
vendorId: any;
 ...
 imgTag:any;
  constructor( private cinemaService: CinemaService, private auth: AuthService) {
    ...
    this.vendorId = id;
    this.cinemaService.getCinemasById(id).subscribe(
        (res:any) => {
            // console.log(res);
          this.markers = res.map((cinema:any)=>{
            //   console.log(cinema);
              return {lat: cinema.Location.lat, lng:cinema.Location.lng};
          }); 
        ...
        //   console.log(res);    
          ...
          this.markers.forEach((marker) => {
            marker.content = parser.parseFromString(svgString, "image/svg+xml").documentElement;
          })
        }
      );
